...
const Hero = (props) => {
    ...
    return (
        <div class="relative bg-white dark:bg-black dark:text-white overflow-hidden">
            <div class="max-w-7xl mx-auto">
                <div
                    class="relative z-10 pb-8 bg-white dark:bg-black dark:text-white sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-32">
                    <svg
